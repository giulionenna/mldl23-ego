...
import tasks
from tasks.MidFusion_task import MidFusion_task
import wandb
...
def main_train(temporal_type = None, ablation = None, loss_weights = None, shift = None):
    ...
    if(args["mid_fusion"]):
        ...
        models['mid_fusion'] = getattr(model_list, args.models[m].model)(device,num_classes, baseline_type, temporal_type, "RGB",n_modalities,
    ...
    action_classifier = MidFusion_task("action-classifier", models, args.batch_size,
